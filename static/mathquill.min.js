...
!(function() {
  ...
  (g = [].slice),
      ...
      (D.p.substituteTextarea = function() {
        ...
        (t.staticMathTextareaEvents = function() {
          ...
          this.container.prepend(
            Mt('<span class="mq-selectable">').text('$' + e.exportLatex() + '$')
          ),
            (e.blurred = !0),
            i
              .bind('cut paste', !1)
    ...
    (j.em = j.italic = j.italics = j.emph = j.textit = j.textsl = u(
      '\\textit',
      'i',
      'class="mq-text-mode"'
    )),
  ...
  it
      ...
      e.createLeftOf = function(e) {
        if (!this.replacedFragment) {
          ...
          i instanceof at &&
            ...
            i !== e[w] &&
              (this.replaces(k(i[q] || e.parent.ends[w], e[w])), (e[w] = i));
        }
    ...
    (ut = j.nthroot = v(ht, function(t, e) {
      (t.htmlTemplate =
        ...
        (t.latex = function() {
          return (
            '\\sqrt[' + this.ends[w].latex() + ']{' + this.ends[q].latex() + '}'
          );
        });
    })),
    (ft = v(P, function(t, e) {
        ...
        (e.finalizeTree = function() {
          (this.ends[w].deleteOutOf = function(t, e) {
            ...
            (this.finalizeTree = this.intentionalBlur = function() {
              this.delimjQs.eq(this.side === w ? 1 : 0).removeClass('mq-ghost'),
                (this.side = 0);
            });
        }),
        ...
        (t.html = function() {
          ...
          return (
            this.eachChild(function(t) {
              n !== t.row && ((n = t.row), (s += '<tr>$tds</tr>'), (i[n] = [])),
                i[n].push('<td>&' + r++ + '</td>');
            }),
            (this.htmlTemplate =
    ...
    (j.ni = j.contains = i(U, '\\ni ', '&ni;')),
    (j.notni = j.niton = j.notcontains = j.doesnotcontain = i(
      U,
      '\\not\\ni ',
      '&#8716;'
    )),
    ...
    (j.nsub = j.notsub = j.nsubset = j.notsubset = i(
      U,
      '\\not\\subset ',
      '&#8836;'
    )),
    (j.nsup = j.notsup = j.nsupset = j.notsupset = j.nsuperset = j.notsuperset = i(
      U,
      '\\not\\supset ',
      '&#8837;'
    )),
    (j.sube = j.subeq = j.subsete = j.subseteq = i(U, '\\subseteq ', '&sube;')),
    (j.supe = j.supeq = j.supsete = j.supseteq = j.supersete = j.superseteq = i(
      U,
      '\\supseteq ',
      '&supe;'
    )),
    ...
    (j.H = j.Hamiltonian = j.quaternions = j.Quaternions = i(
      W,
      '\\mathbb{H}',
      '&#8461;'
    )),
    ...
    (j.not = j['¬'] = j.neg = i(W, '\\neg ', '&not;')),
    (j['…'] = j.dots = j.ellip = j.hellip = j.ellipsis = j.hellipsis = i(
      W,
      '\\dots ',
      '&hellip;'
    )),
    (j.converges = j.darr = j.dnarr = j.dnarrow = j.downarrow = i(
      W,
      '\\downarrow ',
      '&darr;'
    )),
    (j.dArr = j.dnArr = j.dnArrow = j.Downarrow = i(
      W,
      '\\Downarrow ',
      '&dArr;'
    )),
  ...
  (j.impliedby = i(U, '\\Leftarrow ', '&lArr;')),
    ...
    (j.Im = j.imag = j.image = j.imagin = j.imaginary = j.Imaginary = i(
      W,
      '\\Im ',
      '&image;'
    )),
    ...
    (function() {
      ...
      for (
        e = 'sin cos tan arcsin arccos arctan sinh cosh tanh sec csc cot coth'.split(
          ' '
        ),
          t = 0;
        t < e.length;
  ...
  (j.operatorname = v(P, function(e) {
    ...
    (j.Upsilon = j.Upsi = j.upsih = j.Upsih = i(
      N,
      '\\Upsilon ',
